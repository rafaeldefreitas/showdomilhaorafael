...
@NamedQueries({
    ...
    @NamedQuery(name = "Ranking.findByPontos", query = "SELECT r FROM Ranking r WHERE r.pontos = :pontos"),
    @NamedQuery(name = "Ranking.findByData", query = "SELECT r FROM Ranking r WHERE r.data = :data")})
